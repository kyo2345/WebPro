				 	...
				 	<div class="reply">
				 		...
				 		<div class="reply_area">
				 			...
				 			<div class="reply_list">
				 				<!-- 현재 메모글에 해당하는 댓들들을 memo_ripple테이블에서 읽어오기 -->
				 				<?php

				 				//memo_ripple테이블에서 혅 ㅐ메모들의 댓글들
				 	...
				 	<div class="reply_list_content">
				 		<?= $reply_content ?>				 		
				 			...
				 			<div class="reply_write">
				 				...
				 				<form name="formreply" method="post" action="insert_reply.php">
